...
<nav class="navbar navbar-default navbar-inverse navbar-fixed-top">
	...
	<ul class="nav navbar-nav">
		...
		<li class="dropdown"><a href="#" class="dropdown-toggle"
			...
			<ul class="dropdown-menu">
				<li><a href="pages/back/admin/goods/GoodsActionBack!addPre.action"><span class="glyphicon glyphicon-file"></span>&nbsp;添加商品</a></li>
				<li><a href="pages/back/admin/goods/GoodsActionBack!list.action"><span class="glyphicon glyphicon-list"></span>&nbsp;商品列表</a></li>
				<li class="divider"><a href="#"></a></li>
				<li><a href="pages/back/admin/item/ItemActionBack!list.action"><span class="glyphicon glyphicon-th-list"></span>&nbsp;分类管理</a></li>
			</ul></li>
		<li class="dropdown"><a href="#" class="dropdown-toggle"
	...
	<ul class="nav navbar-nav navbar-right">
		<li class="dropdown"><a href="javascript:;"
			...
			<ul class="dropdown-menu main-list">
				...
				<li class="divider"></li>
				<li><a href="pages/back/LoginActionBack!logout.action"><i class="glyphicon glyphicon-log-out"></i>&nbsp;登录注销</a></li>
			</ul></li>
		<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
	</ul>
</nav>

...
import cn.food.fresh.dao.IDetailsDAO;
import cn.food.fresh.dao.IGoodsDAO;
import cn.food.fresh.dao.IOrdersDAO;
import cn.food.fresh.pojo.Goods;
import cn.food.fresh.pojo.Orders;
import cn.food.fresh.service.back.IOrdersServiceBack;
...
public class OrdersServiceBackImpl implements IOrdersServiceBack {
	...
	public Map<String, Object> show(int oid) throws Exception {
		...
		if (orders != null) {
			...
			Map<Integer, Integer> details = this.detailsDAO.findAllByOrdersAndMember(oid);
			// 查询所有的商品数据

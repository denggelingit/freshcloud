package cn.food.fresh.action.front;
...
import cn.food.fresh.pojo.Member;
import cn.food.fresh.service.front.IMemberServiceFront;
import cn.food.fresh.util.ShopcarCookieUtil;
import cn.food.fresh.util.action.AbstractAction;
import cn.food.util.MD5Code;
@Repository
@ParentPackage("root")
@Namespace("/")

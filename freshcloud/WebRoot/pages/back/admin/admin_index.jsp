			...
			<div class="col-md-12 col-xs-12">
				<div class="panel panel-success">
					<div class="panel-heading">
						<strong>生鲜商城后台管理系统</strong>
					</div>
					<div class="panel-body">
						<table class="table table-bordered table-hover">
							<tr>
								<td colspan="3"><span class="h1"><span class="glyphicon glyphicon-user"></span>&nbsp;您好，${mid}！欢迎使用生鲜商城后台管理系统！</span></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><span class="glyphicon glyphicon-file"></span>&nbsp;<a class="text-danger" href="<%=basePath%>pages/back/admin/goods/GoodsActionBack!list.action" id="goodsInfo"></a>件商品</td>
							</tr>
							<tr>
								<td><strong>订单总量</strong></td>
								<td><span class="glyphicon glyphicon-list-alt"></span>&nbsp;<a class="text-info" href="<%=basePath%>pages/back/admin/orders/OrdersActionBack!list.action" id="ordersInfo"></a>个订单</td>
							</tr>
							<tr>

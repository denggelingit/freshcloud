			...
			<div class="col-md-10 col-xs-10">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<strong><span class="glyphicon glyphicon-list"></span>&nbsp;个人信息管理</strong>
					</div>
						...
						<form class="form-horizontal" action="<%=editUrl%>" id="myform" method="post">
							<fieldset>
								<div class="form-group" id="member.phoneDiv">
									<!-- 定义表单提示文字 -->
									<label class="col-md-3 control-label" for="member.phone">联系电话：</label>
									<div class="col-md-5">
										<!-- 定义表单输入组件 -->
								...
								<div class="form-group" id="member.emailDiv">
									<!-- 定义表单提示文字 -->
									<label class="col-md-3 control-label" for="member.email">联系邮箱：</label>
									<div class="col-md-5">
										<!-- 定义表单输入组件 -->

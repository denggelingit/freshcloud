			...
			<div class="col-md-12 col-xs-12">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<strong><span class="glyphicon glyphicon-log-in"></span>&nbsp;用户登录</strong>
					</div>
						...
						<form class="form-horizontal" action="<%=loginUrl%>" id="myform" method="post">
							<fieldset>
								...
								<div class="form-group" id="idDiv">
									<!-- 定义表单提示文字 -->
									<label class="col-md-3 control-label" for="id">登录名(登录名为guest)：</label>
									<div class="col-md-5">
										<!-- 定义表单输入组件 -->
								...
								<div class="form-group" id="member.passwordDiv">
									<!-- 定义表单提示文字 -->
									<label class="col-md-3 control-label" for="member.password">登录密码(密码为guest)：</label>
									<div class="col-md-5">
										<!-- 定义表单输入组件 -->
